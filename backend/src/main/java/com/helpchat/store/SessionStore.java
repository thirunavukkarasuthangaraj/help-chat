...
/**
 * Conversation history per session, kept in memory with a 24h TTL.
 *
 * PRODUCTION: replace with DynamoDB table `chat_sessions`
 *   PK: sessionId, attribute: messages (list), TTL attribute: expiresAt.
 */
@Component
